...
final class HomeView_UITests: XCTestCase {
    ...
    override func tearDownWithError() throws {
        app.navigationBars["Crypto Universe"]/*@START_MENU_TOKEN@*/.buttons["Перетянуть"]/*[[".otherElements[\"Перетянуть\"].buttons[\"Перетянуть\"]",".buttons[\"Перетянуть\"]"],[[[-1,1],[-1,0]]],[0]]@END_MENU_TOKEN@*/.tap()
    ...
    func test_HomeView_Page_ShouldLoadData() {
        ...
        let data = app.collectionViews/*@START_MENU_TOKEN@*/.scrollViews/*[[".cells.scrollViews",".scrollViews"],[[[-1,1],[-1,0]]],[0]]@END_MENU_TOKEN@*/.otherElements.scrollViews.otherElements.containing(.staticText, identifier:"Overall").children(matching: .other).element.waitForExistence(timeout: 30)
    ...
    func test_HomeView_Action_ShouldCloseHelp() {
        ...
        let button = cryptoUniverseNavigationBar/*@START_MENU_TOKEN@*/.buttons["Перетянуть"]/*[[".otherElements[\"Перетянуть\"].buttons[\"Перетянуть\"]",".buttons[\"Перетянуть\"]"],[[[-1,1],[-1,0]]],[0]]@END_MENU_TOKEN@*/
        button.tap()
    ...
    func test_HomeView_Action_ExchangeAction() {
        ...
        let exchangeAPI = collectionViewsQuery/*@START_MENU_TOKEN@*/.textFields["Exchange API"]/*[[".cells.textFields[\"Exchange API\"]",".textFields[\"Exchange API\"]"],[[[-1,1],[-1,0]]],[0]]@END_MENU_TOKEN@*/
        let exchangeSecret = collectionViewsQuery/*@START_MENU_TOKEN@*/.textFields["Exchange Secret"]/*[[".cells.textFields[\"Exchange Secret\"]",".textFields[\"Exchange Secret\"]"],[[[-1,1],[-1,0]]],[0]]@END_MENU_TOKEN@*/
        ...
        collectionViewsQuery/*@START_MENU_TOKEN@*/.buttons["Add cryptoexchange"]/*[[".cells.buttons[\"Add cryptoexchange\"]",".buttons[\"Add cryptoexchange\"]"],[[[-1,1],[-1,0]]],[0]]@END_MENU_TOKEN@*/.tap()
    ...
    func test_HomeView_Action_FailExchangeAction() {
        ...
        let exchangeApiTextField = collectionViewsQuery2/*@START_MENU_TOKEN@*/.textFields["Exchange API"]/*[[".cells.textFields[\"Exchange API\"]",".textFields[\"Exchange API\"]"],[[[-1,1],[-1,0]]],[0]]@END_MENU_TOKEN@*/
        ...
        collectionViewsQuery/*@START_MENU_TOKEN@*/.textFields["Exchange Secret"]/*[[".cells.textFields[\"Exchange Secret\"]",".textFields[\"Exchange Secret\"]"],[[[-1,1],[-1,0]]],[0]]@END_MENU_TOKEN@*/.tap()
    ...
    func test_HomeView_Action_FailManualCcy() {
        ...
        let collectionViewsQuery = app.collectionViews
        collectionViewsQuery/*@START_MENU_TOKEN@*/.textFields["Cryptocurrency code"]/*[[".cells.textFields[\"Cryptocurrency code\"]",".textFields[\"Cryptocurrency code\"]"],[[[-1,1],[-1,0]]],[0]]@END_MENU_TOKEN@*/.tap()
        ...
        collectionViewsQuery/*@START_MENU_TOKEN@*/.textFields["Quantity"]/*[[".cells.textFields[\"Quantity\"]",".textFields[\"Quantity\"]"],[[[-1,1],[-1,0]]],[0]]@END_MENU_TOKEN@*/.tap()
        
        let key = app/*@START_MENU_TOKEN@*/.keys["Удалить"]/*[[".keyboards.keys[\"Удалить\"]",".keys[\"Удалить\"]"],[[[-1,1],[-1,0]]],[0]]@END_MENU_TOKEN@*/
        key.tap()
        
        let key2 = app/*@START_MENU_TOKEN@*/.keys["1"]/*[[".keyboards.keys[\"1\"]",".keys[\"1\"]"],[[[-1,1],[-1,0]]],[0]]@END_MENU_TOKEN@*/
        key2.tap()
        
        collectionViewsQuery/*@START_MENU_TOKEN@*/.buttons["Add cryptocurrency"]/*[[".cells.buttons[\"Add cryptocurrency\"]",".buttons[\"Add cryptocurrency\"]"],[[[-1,1],[-1,0]]],[0]]@END_MENU_TOKEN@*/.tap()
    ...
    func test_HomeView_Action_ManualCcy() {
        ...
        _ = app.collectionViews/*@START_MENU_TOKEN@*/.scrollViews/*[[".cells.scrollViews",".scrollViews"],[[[-1,1],[-1,0]]],[0]]@END_MENU_TOKEN@*/.otherElements.scrollViews.otherElements.containing(.staticText, identifier:"Overall").children(matching: .other).element.waitForExistence(timeout: 30)
        ...
        scrollViewsQuery2.otherElements.containing(.staticText, identifier:"OKX").children(matching: .other).element.swipeLeft()
//        scrollViewsQuery2.otherElements.containing(.staticText, identifier:"Binance").children(matching: .other).element.swipeLeft()
        scrollViewsQuery2.otherElements.containing(.staticText, identifier:"Kraken").children(matching: .other).element.swipeLeft()
        ...
        let element3 = scrollViewsQuery.otherElements.containing(.staticText, identifier:"Manual").children(matching: .other).element
